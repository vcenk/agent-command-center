(function() {
  ...
  async function init() {
    ...
    const container = createWidget(config.launcher_label);

    // Event listeners
    const launcher = container.querySelector('.chat-widget-launcher');
    const closeBtn = container.querySelector('.chat-widget-close');
    const chatWindow = container.querySelector('.chat-widget-window');
